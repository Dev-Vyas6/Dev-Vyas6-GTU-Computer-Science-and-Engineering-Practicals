// AIM : Write a GUI program that use button to move the message to the left and right and use the radio button to change the color for the message displayed.
...
public class P20 extends Application {
    ...
    @Override
    // Override the stage method in the Application class
